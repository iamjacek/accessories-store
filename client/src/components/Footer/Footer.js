...
<div className="container mx-auto px-12 py-8 sm:py-6">
    ...
    <div className="pt-4 flex justify-center md:flex items-center border-t-2 border-gray-300">
        <ul className="text-center">
            ...
            <li className="sm:mx-2 sm:inline leading-7 text-sm" id="footer-navi-2"><a className="text-gray-700  text-small hover:text-purple-600" href="/privacy">Privacy</a></li>
            </ul>
    </div>
